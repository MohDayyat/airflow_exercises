...
CREATE TABLE public.employe(id INT NOT NULL, name VARCHAR(250) , age INT );
"""

insert_data_query = """
INSERT INTO public.employe(id,name,age)
VALUES (1,'Mohammad',31), (2,'Ahmad',20), (3,'Abdullah',37)
"""
...
group_data = PostgresOperator(task_id = "calculating_averag_age", 
